...
import com.xuxiaojian.aipassagecreator.config.SvgDiagramConfig;
...
/**
 * ClassName: SvgDiagramService
 * Package: com.xuxiaojian.aipassagecreator.service.strategy.impl
 * Description:
 * SVG 概念示意图生成服务
 * 使用 AI 生成 SVG 代码，适合概念示意、思维导图样式、关系展示等场景
 * @Author 阿健
 * @Create 2026-05-30 2:43
 * @Version 1.0
 */
@Service
@Slf4j
public class SvgDiagramService implements ImageSearchService {
    ...
    public ImageData getImageData(ImageRequest request) {
        String requirement = request.getEffectiveParam(getMethod().isAiGenerated());
